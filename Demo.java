...
public class Demo {
    ...
    public static void main(String[] args) {
        ...
        secret = scnr.nextLine().toUpperCase(); // Convert to uppercase
    ...
    private static boolean getGuess(Scanner scnr, String secret, List<Character> previousGuesses) {
        ...
        guess = scnr.nextLine().toUpperCase(); // Convert to uppercase
        previousGuesses.add(guess.charAt(0));

        return (secret.contains(guess));
    }

    // Checks player guesses versus secret word and prints dashes when not found.
